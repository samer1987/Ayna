    ...
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
            ...
            new Chart(f, {
                ...
                data: {
                    ...
                    datasets: [{
                       ...
                       pointBorderColor: "rgba(38, 185, 154, 0)",
                       pointBackgroundColor: "rgba(38, 185, 154, 0)",
                       pointHoverBackgroundColor: "#fff",
                       pointHoverBorderColor: "rgba(220,220,220,1)",
                        pointBorderWidth: 1,
                        data: [10, 4, 6, 9, 20, 2, 7]
                    }, {
                        label: "",
                        backgroundColor: "rgba(3, 88, 106, 0)",
                        borderColor: "rgba(255, 56, 182, 1)",
                        pointBorderColor: "rgba(3, 88, 106, 0)",
                        pointBackgroundColor: "rgba(3, 88, 106, 0)",
                        pointHoverBackgroundColor: "#fff",
                        pointHoverBorderColor: "rgba(151,187,205,1)",
                        pointBorderWidth: 1,
                       data: [8, 8, 12, 15, 30, 5, 14]
                    },
					{
                        label: "",
                        backgroundColor: "rgba(3, 88, 106, 0)",
        ...
        if ($("#canvasDoughnut").length) {
            var f = document.getElementById("canvasDoughnut"),
                i = {
                    labels: ["120", "80", "140", "120", "200"],
                    datasets: [{
                        data: [120, 80, 140, 120, 200],
                        backgroundColor: ["#739c36", "#a3cf62", "#c5ea8d", "#567528", "#a3cf62"],
                        hoverBackgroundColor: ["#84c341", "#84c341", "#84c341", "#84c341", "#84c341"]
                    }]
                };
            new Chart(f, {
                type: "doughnut",
                tooltipFillColor: "rgba(132, 195, 65, 1)",
                data: i
            })
        }
